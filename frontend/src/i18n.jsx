...
const DICT = {
  fr: {
    ...
    addProduct: 'Ajouter un produit', search: 'Rechercher', add: 'Ajouter', cancel: 'Annuler',
        thisWeek: 'Cette semaine', weeksAgo: 'Il y a (sem.)', entriesLabel: 'entrée(s)', thisMonth: 'Ce mois',
  ...
  en: {
    ...
    thisWeek: 'This week', weeksAgo: 'weeks ago', entriesLabel: 'entries', thisMonth: 'This month',

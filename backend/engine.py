...
WHY = {
    "fr": {
        ...
        "hydratant": "La plus riche scelle le reste — en dernier le soir, juste avant le SPF le matin.",
    ...
    "en": {
        ...
        "hydratant": "The richest one seals the rest — last at night, right before SPF in the morning.",
